...
do
 ...
 ssh -n -o StrictHostKeyChecking=no root@${string[1]} "apt-get install unzip"
 ssh -n -o StrictHostKeyChecking=no root@${string[1]} "unzip ${string[1]}.zip"
 ...
 ssh -n -o StrictHostKeyChecking=no root@${string[1]} "rm ${string[1]}.zip && rm -rf ${string[1]}"
done
